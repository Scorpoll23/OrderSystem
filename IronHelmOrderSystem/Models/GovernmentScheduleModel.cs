...
{
    [Serializable]
    public class GovernmentScheduleModel : ScheduleModel
    {
        public GovernmentScheduleModel()
        {
        ...
        {
            ScheduleFactory.Instance.RegisterSchedule(OrderSource.Governmental, new GovernmentScheduleModel());
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(GovernmentScheduleModel)) return false;
            return Equals((GovernmentScheduleModel)obj);
        }
    }
}
